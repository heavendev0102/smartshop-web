...
const AddProductForm = () => {
    ...
    const { register, handleSubmit, watch, setValue, reset, formState: { errors }, } = useForm<ProductFormValues>({
        ...
        defaultValues: { name: "", image_url: "", current_price: 0, original_price: 0, discount_percent: 0, category_slugs: [], section_slugs: [], },
    });
    ...
    const category_slugs = watch("category_slugs");
    const section_slugs = watch("section_slugs");
